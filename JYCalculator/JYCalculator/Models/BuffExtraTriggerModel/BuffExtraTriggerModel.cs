...
namespace JYCalculator.Models.BuffExtraTriggerModel
{
    ...
    /// 用于计算特殊触发BUFF的模型
    /// </summary>
    public class BuffExtraTriggerModel
    {
        #region 成员
        ...
        public readonly BuffExtraTriggerArg Arg;
        ...
        public BuffExtraTriggerModel()
        {
            BuffCover = new BuffCoverDF();
        }

        public BuffExtraTriggerModel(SkillNumModel skill, FullCharacter fchar,
            Period<SkillDataDF> skillDatas,
            BuffExtraTriggerArg arg)
        {
            SkillNum = skill;
            InputChar = fchar;
    ...
    public readonly struct BuffExtraTriggerArg
    {
        ...
        public BuffExtraTriggerArg(bool sl, bool sy, bool bigFM_SHOES_120, bool bigXW)
        {
            SL = sl;
            SY = sy;
