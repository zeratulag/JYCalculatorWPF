...
namespace JYCalculator.Src.DB
{
    public class JYDataBase
    {
        ...
        public static readonly ImmutableHashSet<string> UselessAttrs = StaticJYData.Data.UselessAttrs;
        ...
        public JYDataBase(TargetDB target, AbilityDB ability,
            ZhenFaDB zhenFa,
