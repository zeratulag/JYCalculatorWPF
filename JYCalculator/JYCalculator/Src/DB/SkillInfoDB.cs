...
namespace JYCalculator.Src.DB
{
    public class SkillInfoDB : IDB<string, SkillInfoItem>
    {
        ...
        public SkillInfoDB(JYDataLoader jyDataLoader) : this(jyDataLoader.SkillData, jyDataLoader.SkillEvent)
        {
        }

        public SkillInfoDB() : this(StaticJYData.Data)
        {
        }
        ...
        public void SummarySkillTriggerEvent()
        {
            ...
            var (skill2event, event2skill) = SummarySkillItem(Events, SkillInfoItem.CanTrigger);
        ...
        public void SummarySkillEffectRecipe(IDictionary<string, Recipe> recipes)
        {
            ...
            var (skill2recipe, recipe2skill) = SummarySkillItem(recipes, SkillInfoItem.CanEffectRecipe);
