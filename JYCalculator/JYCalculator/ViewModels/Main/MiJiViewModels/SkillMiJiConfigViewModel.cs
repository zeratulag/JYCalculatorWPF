...
namespace JYCalculator.ViewModels 
{
    ...
    public class AllSkillMiJiConfigViewModel : CollectionViewModel<SkillMiJiViewModel>
    {
        ...
        [DoNotNotify]
        public bool HasQiPo => SkillMiJi["BY"].HasQiPo;
        ...
        public AllSkillMiJiConfigViewModel() : this(StaticJYData.DB.Recipe)
        {
        }
        ...
        {
            IsSupport = ActivedRecipeIDs.IsSupersetOf(StaticJYData.Data.Setting.EssentialMiJis);
        }
        ...
        protected void GetOtherRecipes()
        {
            ...
            if (Config.ContainsKey(3096))
            {
                ...
                {
                    OtherRecipes.Add(StaticJYData.DB.Recipe.Get("MJ_ShunFaZhuiMingJianZengShang"));
                }
            }
        }
