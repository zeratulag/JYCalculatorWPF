...
namespace JYCalculator.ViewModels
{
    public class InitInputViewModel : AbsDependViewModel<AbsViewModel>
    {
        ...
        public EquipSpecialEffectConfigViewModel EquipSpecialEffectVM { get; }
        ...
        public InitInputViewModel(InitCharacter initchar, EquipOptionConfigViewModel equip,
            BigFMConfigViewModel bigFmvm, EquipSpecialEffectConfigViewModel equipSpecialEffectVM)
            : base(InputPropertyNameType.None, initchar, equip, bigFmvm, equipSpecialEffectVM)
        {
            InitCharVM = initchar;
            EquipOptionVM = equip;
            BigFMVM = bigFmvm;
            EquipSpecialEffectVM = equipSpecialEffectVM;
        ...
        {
            var res = new InitInputSav(InitCharVM, EquipOptionVM.Export(), BigFMVM.Config, EquipSpecialEffectVM.Config);
            return res;
        }
        ...
        protected void _Load(InitInputSav sav)
        {
            ...
            EquipSpecialEffectVM.Load(sav.EquipSpecialEffect);
        }
    ...
    public class InitInputSav
    {
        ...
        public readonly IDictionary<string, string> EquipSpecialEffect;

        public InitInputSav(InitCharacter initChar, EquipOptionConfigSav equipOption, BigFMSlotConfig[] bigFM,
            IDictionary<string, string> equipSpecialEffect)
        {
            InitChar = initChar;
            EquipOption = equipOption;
            BigFM = bigFM;
            EquipSpecialEffect = equipSpecialEffect;
        }
    }
}