...
namespace JYCalculator.ViewModels
{
        ...
        IRecipient<PzPlanMessage>
    {
        ...
        public EquipSpecialEffectConfigViewModel EquipSpecialEffectVM { get; } // 装备特效配置
        ...
        public RelayCommand OpenLogFileDirCmd { get; }
        ...
        public MainWindowViewModels(MainWindow mw) : base(InputPropertyNameType.None)
        {
            ...
            EquipSpecialEffectVM = new EquipSpecialEffectConfigViewModel();

            InitInputVM = new InitInputViewModel(InitCharVM, EquipOptionVM, BigFMVM, EquipSpecialEffectVM);
            ...
            OpenLogFileDirCmd = new RelayCommand(OpenLogFileDir);
        ...
        public void OpenLogFileDir()
        {
            // 获取当前日志文件路径
            var app = (App)Application.Current;
            var logfile = app.LogFilePath;
...
#if DEBUG
            Log.Information($"计算总耗时：{elapsedMs}ms");
#endif
        }
